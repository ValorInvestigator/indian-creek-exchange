...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "cabin supplies",
    "La Grande lumber",
    "cedar fencing supply La Grande",
    "custom milling Wallowa Mountains",
    "lumber yard Elgin",
    "Western Red Cedar",
    "Incense Cedar",
    "lumber Eastern Oregon",
    "lumber Tri-Cities",
    "cedar lumber Kennewick",
    "fencing materials Walla Walla",
    "bulk lumber contractor Eastern Oregon",
    "cedar supplier Wallowa County",
    "building materials Baker City",
  ],
  openGraph: {
    type: "website",
    locale: "en_US",
  ...
  verification: {
    google: "PD0HDOEpUJr3lYl98Qu4VbdVExCDI4Aq-itMb6cwBaE",
  },
};
