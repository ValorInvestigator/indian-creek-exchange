    ...
    return (
        <div className="bg-offwhite min-h-screen py-16">
            <div className="max-w-4xl mx-auto px-4 prose prose-lg prose-forest bg-white p-8 md:p-12 shadow-sm rounded-lg border border-gray-100">
                ...
                <p className="mb-4">
                    At Indian Creek Exchange, we respect your privacy and are committed to protecting it through our compliance with this policy. This policy describes the types of information we may collect from you or that you may provide when you visit the website indian-creek-exchange.vercel.app and our practices for collecting, using, maintaining, protecting, and disclosing that information.
                </p>
